...
parser.add_argument("-k","--k_neg_pair",type = list, default=[4])
...
parser.add_argument("--addtion",type = str, default="kin1_14_bp",help='description for this training')
...
def main():
    ...
    for circle in SELECT_SPLIT:
        ...
        if args.type == 'KINFACE1':
            related_list = get_train_loader_kinface1(args.type,circle,F_S_COLLECTION,F_D_COLLECTION,M_D_COLLECTION,M_S_COLLECTION,BATCH_SIZE,args.picroot)
            train_loader = related_list[0]
            
        elif args.type == 'KINFACE2':
            related_list = get_train_loader_kinface2(args.type,circle,COLLECTION,BATCH_SIZE,args.picroot)
            train_loader = related_list[0]
            test_indices = related_list[1]
            
        elif args.type == 'TSKINFACE':
            test_index_for_son = FMS_COLLECTION['split_'+str(circle)]
            test_index_for_dau = FMD_COLLECTION['split_'+str(circle)]
